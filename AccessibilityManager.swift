...
extension Color {
    ...
    static func accessibleCardBackground(isHighContrast: Bool) -> Color {
        return isHighContrast ? .white : MasonColors.secondaryBackground
    }
}
...
extension View {
    ...
    func accessibilityKeyboardShortcut(_ key: KeyEquivalent, modifiers: EventModifiers = []) -> some View {
